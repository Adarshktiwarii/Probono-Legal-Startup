    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-20">
        <div className="container max-w-4xl">
          <h2 className="text-xl font-medium text-foreground mb-8 text-center">Our three-pillar assessment</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={pillar.title} className="border border-border rounded-xl p-6">
        ...
        <div className="container max-w-4xl">
          <div className="grid md:grid-cols-5 gap-8 items-start">
            ...
            <div className="md:col-span-3">
              <h2 className="text-xl font-medium text-foreground mb-5">Cases we accept</h2>
        ...
        <div className="container max-w-4xl">
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <h2 className="text-xl font-medium text-foreground mb-4">Currently serving two states</h2>
              <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                IPBLI is currently operational in the <span className="text-foreground font-medium">National Capital Territory of Delhi</span> and the <span className="text-foreground font-medium">State of Madhya Pradesh</span>. We plan to expand to additional states in upcoming phases.
              </p>
              <div className="flex gap-3">
                <div className="flex-1 border border-border rounded-xl p-4 text-center">
                  ...
                  <p className="text-sm font-medium text-foreground">New Delhi</p>
                  <p className="text-[11px] text-muted-foreground mt-0.5">NCT of Delhi</p>
                </div>
                <div className="flex-1 border border-border rounded-xl p-4 text-center">
                  ...
                  <p className="text-sm font-medium text-foreground">Madhya Pradesh</p>
                  <p className="text-[11px] text-muted-foreground mt-0.5">All districts</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 className="text-xl font-medium text-foreground mb-4">We represent you at every level</h2>
              <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 rounded-lg border border-border">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">District & Sessions Courts</p>
                    <p className="text-[11px] text-muted-foreground">Trial courts — where most cases begin</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg border border-border">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">High Courts</p>
                    <p className="text-[11px] text-muted-foreground">Delhi HC · MP HC (Jabalpur, Indore & Gwalior)</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg border border-border">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Supreme Court of India</p>
                    <p className="text-[11px] text-muted-foreground">The apex court — for appeals & constitutional matters</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-muted">
        <div className="container max-w-3xl text-center">
          ...
          <h2 className="text-xl font-medium text-foreground mb-3">Every stage of your legal journey</h2>
          <p className="text-sm text-muted-foreground leading-relaxed mb-8 max-w-lg mx-auto">
            Whether you need to file a fresh case, challenge a subordinate court order, or file an appeal — we represent you at <span className="text-foreground font-medium">every phase</span> of the legal process.
          </p>

          <div className="grid grid-cols-3 gap-px bg-[#e8e3db] rounded-xl overflow-hidden border border-border max-w-2xl mx-auto">
            <div className="bg-background p-6">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-3">
                <FilePlus className="w-4 h-4 text-[#1E3A5F]" />
              </div>
              <p className="text-sm font-medium text-foreground mb-1">Fresh Filing</p>
              <p className="text-[11px] text-muted-foreground leading-relaxed">New FIRs, complaints, bail applications & petitions</p>
            </div>
            <div className="bg-background p-6">
              ...
              <p className="text-sm font-medium text-foreground mb-1">Challenge Orders</p>
              <p className="text-[11px] text-muted-foreground leading-relaxed">Revisions & challenges against lower court decisions</p>
            </div>
            <div className="bg-background p-6">
              ...
              <p className="text-sm font-medium text-foreground mb-1">Appeals</p>
              <p className="text-[11px] text-muted-foreground leading-relaxed">High Court & Supreme Court appeals at every stage</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="container max-w-xl text-center">
          <p className="text-sm text-muted-foreground mb-4">Think you qualify? Our application takes less than 10 minutes.</p>
