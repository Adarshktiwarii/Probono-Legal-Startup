  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-md px-6">
        ...
        <h1 className="text-6xl font-medium text-[#1A1A2E] mb-3">404</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/apply" className="inline-flex items-center justify-center rounded-full border border-[#e8e3db] text-[#6B7280] hover:bg-gray-50 text-sm h-10 px-6 transition-colors">
            Apply for help
          </Link>
          <Link href="/contact" className="inline-flex items-center justify-center rounded-full border border-[#e8e3db] text-[#6B7280] hover:bg-gray-50 text-sm h-10 px-6 transition-colors">
            Contact us
          </Link>
        </div>
      </div>
