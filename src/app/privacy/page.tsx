  ...
  return (
    <div className="py-16">
      <div className="container max-w-2xl">
        <h1 className="text-2xl font-medium text-foreground mb-2">Privacy Policy</h1>
        <p className="text-xs text-muted-foreground mb-8">Last updated: June 2026</p>

        <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">Data Security</h2>
