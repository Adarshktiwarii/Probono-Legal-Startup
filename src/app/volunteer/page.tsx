...
export default function Volunteer() {
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-20">
        <div className="container max-w-3xl">
          <h2 className="text-xl font-medium text-foreground mb-4">Why join our panel?</h2>
      ...
      <section className="py-16 md:py-20 bg-muted">
        <div className="container max-w-3xl">
          <h2 className="text-xl font-medium text-foreground mb-8">Selection criteria</h2>
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              <div key={item.label} className="flex gap-3 p-4 border border-border rounded-xl bg-background">
      ...
      <section className="py-16 md:py-20">
        <div className="container max-w-lg text-center">
          ...
          <h2 className="text-xl font-medium text-foreground mb-3">Phase 1 onboarding is complete</h2>
