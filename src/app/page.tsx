    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative z-10 py-20 md:py-32">
          <div className="max-w-xl">
            <p className="inline-flex items-center gap-2 text-sm text-[#1E3A5F] font-medium mb-4 tracking-wide bg-secondary/15 px-4 py-1.5 rounded-full border border-[#C69C3F]/25">
              <span className="w-1.5 h-1.5 rounded-full bg-[#C69C3F]" />
              India&apos;s Pro Bono Legal Institution
            </p>
            <h1 className="text-3xl md:text-[42px] font-medium text-foreground leading-tight tracking-tight mb-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/eligibility">
                <Button variant="outline" className="rounded-full border-border text-muted-foreground hover:bg-muted h-11 px-7 text-sm shadow-none w-full sm:w-auto">
                  Check eligibility
                </Button>
              </Link>
            </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-medium text-foreground mb-2">How IPBLI works</h2>
            <p className="text-sm text-muted-foreground max-w-md mx-auto">A dignified, three-step process from application to courtroom representation.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-px bg-[#e8e3db] max-w-4xl mx-auto rounded-xl overflow-hidden border border-border">
            <div className="bg-background p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-medium text-foreground">You apply</h3>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">Fill out a secure intake form with your personal details, financial situation, and the legal issue you face.</p>
            </div>
            <div className="bg-background p-8">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">Our operations team manually assesses your eligibility based on financial need, vulnerability, and case impact.</p>
            </div>
            <div className="bg-background p-8">
              <div className="flex items-center gap-3 mb-4">
                <span className="w-8 h-8 rounded-full bg-[#5B8A72] text-white text-sm flex items-center justify-center font-medium">3</span>
                <h3 className="text-sm font-medium text-foreground">You get represented</h3>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">A qualified, empaneled advocate is assigned to your case and represents you at zero cost.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <h2 className="text-2xl font-medium text-foreground mb-3">Cases we are accepting</h2>
              <p className="text-sm text-muted-foreground mb-6">We focus on matters where fundamental rights, liberty, or safety are at immediate risk.</p>
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.label} className="flex items-center gap-3 p-3 rounded-lg border border-border hover:bg-muted transition-colors">
        ...
        <div className="container max-w-3xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <div className="text-xs text-muted-foreground mt-1">Cost to citizen</div>
            </div>
            <div>
              <div className="text-2xl font-medium text-[#C75B39]">100%</div>
              <div className="text-xs text-muted-foreground mt-1">Pro bono</div>
            </div>
            <div>
              <div className="text-2xl font-medium text-[#C69C3F]">Delhi & MP</div>
              <div className="text-xs text-muted-foreground mt-1">Phase 1 regions</div>
            </div>
            <div>
              <div className="text-2xl font-medium text-[#5B8A72]">Secure</div>
              <div className="text-xs text-muted-foreground mt-1">Encrypted platform</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="container max-w-xl text-center">
          <h2 className="text-2xl font-medium text-foreground mb-3">Are you facing a legal crisis?</h2>
