      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12">
          <blockquote className="text-white/95 text-xl md:text-2xl leading-relaxed font-light italic mb-4">
            &ldquo;Law and order are the medicine of the body politic and when the body politic gets sick, medicine must be administered.&rdquo;
          </blockquote>
          <div className="flex items-center gap-3">
            <div className="w-px h-8 bg-[#C69C3F]" />
            <div>
              <p className="text-[#C69C3F] text-sm font-medium">Dr. B.R. Ambedkar</p>
              <p className="text-white/50 text-xs">Chairman, Constitution Drafting Committee</p>
            </div>
          </div>
        </div>
